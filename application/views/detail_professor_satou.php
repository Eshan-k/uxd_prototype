                            ...
                            <table>
                                <tr>
                                    <td align="left" width="400px">
                                        <img src="../../public/images/quinn.jpeg" style="margin-left: 5%" width="300px" height="300px" class="img-responsive">
                                    </td>
                                    <td>
                                    ...
                                    <div class="col-lg-12">
                                        <table class="table table-hover table-striped dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><span class="label bg-green">4.0</span></td>
                                            </tr>
                                            <tr role="row" class="even">
                                                <td>2/11/2017</td>
                                                <td>Student 2b</td>
                                                <td>Lot of assignment.</td>
                                                <td><span class="label bg-amber">3.5</span></td>
                                            </tr>
                                            <tr role="row" class="odd">
                                                <td>12/22/2016</td>
                                                <td>Student 3c</td>
        ...
        <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" style="display: none;">
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <span style="margin-top: 15%; margin-left: 93%">
							<button type="button" class="btn btn-link waves-effect" data-dismiss="modal" style=""><b>X</b></button>
                    </span>
