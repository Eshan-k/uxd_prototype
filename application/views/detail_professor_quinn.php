	...
	<div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h3 class="text-black">Professor Quinn</h3>
                        <h2>CS - 632, OS&nbsp;
                            <span><a target="_blank" href="#">LinkedIn</a></span></h2>
                        <span class="header-dropdown m-r--5">
							<h3>Overall Rating: <span class="label bg-amber">3</span></h3>
						</span>
                    </div>
                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="ml-menu" style="display: none;">
                            <h4>
                                Doing research on <i>Multi processing</i> in OS.
                                <br>
                            </h4>
                        </ul>
                    </div>
